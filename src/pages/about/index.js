      ...
      <div>
        ...
        <div className="bg-gradient-to-r from-sky-500 to-indigo-500">
          <div
            ...
            style={{
              backgroundImage: `url('/assets/about-images (2).png')`, 
              backgroundSize: '50%',  
